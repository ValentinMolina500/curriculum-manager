...
(async () => {
    ...
    await page.goto('https://catalog.wsu.edu/Tri-Cities/Courses/BySubject/CHE');
    try {
        ...
        //   path: 'chemical_engineering_courses.csv',
        //   header: [
        ...
        xlsx.writeFile(wb, "chemical_engineering_courses.xlsx")
