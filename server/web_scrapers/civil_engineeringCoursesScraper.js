...
(async () => {
    ...
    await page.goto('https://catalog.wsu.edu/Tri-Cities/Courses/BySubject/CE');
    try {
        ...
        //   path: 'civil_engineering_courses.csv',
        //   header: [
        ...
        xlsx.writeFile(wb, "civil_engineering_courses.xlsx")
