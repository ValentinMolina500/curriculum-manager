...
(async () => {
    ...
    await page.goto('https://catalog.wsu.edu/Tri-Cities/Courses/BySubject/ME');
    try {
        ...
        //   path: 'mechanical_engineering_courses.csv',
        //   header: [
        ...
        xlsx.writeFile(wb, "mechanical_engineering_courses.xlsx")
