...
(async () => {
    ...
    await page.goto('https://catalog.wsu.edu/Tri-Cities/Courses/BySubject/E_E');
    try {
        ...
        //   path: 'electrical_engineering_courses.csv',
        //   header: [
        ...
        xlsx.writeFile(wb, "electrical_engineering_courses.xlsx")
